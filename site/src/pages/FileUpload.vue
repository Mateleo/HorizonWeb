  ...
  <div class="text-1 bg-white">
    ...
    >
      <div class="flex items-center">
        ...
        <div class="flex-auto border-t-2 transition duration-500 ease-in-out border-teal-600" />
    ...
    >
      ...
      <section v-if="step == 3">
        <h3> Step 3 </h3>
        <p>
          Disclaimer: si vous uploadez un fichier, il sera public et accessible par tous
          Si vous souhaitez que des informations soient floutées, corrigées ou généralement modifiées, nous vous ferrons une proposition avec des informations sensibles retirées et attendrons votre confirmation avant de rendre le fichier public
        </p>
